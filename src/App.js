...
const links = [
  {logo: linkedin, text: "LinkedIn", link: "https://www.linkedin.com/in/mark-ivkovic-68822474/"},
  ...
  return (
    <div className="App">
      <div className="left-side">
        ...
        <Card info={summary}/>
        <Card info={tech}/>
        <Card info={experience}/>
        <Card info={projects}/>
      </div>

      <div className="right-side" >
        <img src={profilepic} alt="White male wearing yellow sweater with dog"></img>
        <h3>Mark Ivkovic</h3>
        <h4>Web Developer</h4>
        <h5>Sheffield - UK</h5>
        <div className="links">
